  ...
  return (
    <main className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-textLight text-sm mb-10">Dernière mise à jour : août 2026</p>
        ...
        <div className="space-y-8 text-sm text-textDark leading-relaxed">
          ...
          <section>
            ...
            <p>
              Les présentes conditions générales régissent l&apos;utilisation du service {config.app.name}, édité par Devlyn (micro-entreprise), accessible à <strong>{config.app.domain}</strong>, ainsi que la souscription à l&apos;abonnement Premium. En créant un compte, vous acceptez l&apos;intégralité des présentes conditions.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-textLight">
              Conformément à l&apos;article L221-28 du Code de la consommation, le droit de rétractation de 14 jours ne s&apos;applique pas aux services numériques dont l&apos;exécution a commencé avec votre accord avant l&apos;expiration du délai. Si vous souhaitez exercer ce droit avant toute utilisation, contactez-nous à <a href="mailto:contact@myquotidia.app" className="text-primary hover:underline">contact@myquotidia.app</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Les présentes CGU sont soumises au droit français. En cas de litige, une solution amiable sera recherchée en priorité via <a href="mailto:contact@myquotidia.app" className="text-primary hover:underline">contact@myquotidia.app</a>. À défaut, vous pouvez recourir à la médiation de la consommation conformément à la directive européenne 2013/11/UE.
            </p>
          </section>

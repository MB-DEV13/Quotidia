        ...
        <div className="space-y-8 text-sm text-textDark leading-relaxed">
          ...
          <section>
            ...
            <ul className="mt-3 space-y-1 text-textLight pl-4 border-l-2 border-gray-100">
              <li><strong className="text-textDark">Raison sociale :</strong> Devlyn (micro-entreprise)</li>
              <li><strong className="text-textDark">Nom du dirigeant :</strong> Bachini Mario</li>
              <li><strong className="text-textDark">SIRET :</strong> 103 373 932 00013</li>
              <li><strong className="text-textDark">Adresse :</strong> 62 passage de la Noria de Font de Garach, 13120 Gardanne, France</li>
              <li><strong className="text-textDark">Email :</strong> <a href="mailto:contact@myquotidia.app" className="text-primary hover:underline">contact@myquotidia.app</a></li>
              <li><strong className="text-textDark">Directeur de la publication :</strong> Bachini Mario</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>Pour toute question, contactez-nous à : <a href="mailto:contact@myquotidia.app" className="text-primary hover:underline">contact@myquotidia.app</a></p>
          </section>

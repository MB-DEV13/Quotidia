  ...
  return (
    <main className="min-h-screen bg-background py-16 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-textLight text-sm mb-10">Dernière mise à jour : août 2026 — conforme RGPD</p>
        ...
        <div className="space-y-8 text-sm text-textDark leading-relaxed">
          ...
          <section>
            ...
            <p>
              Le responsable du traitement des données personnelles collectées via {config.app.name} est Devlyn (micro-entreprise, Bachini Mario), voir <Link href="/legal/mentions-legales" className="text-primary hover:underline">mentions légales</Link>. Contact : <a href="mailto:contact@myquotidia.app" className="text-primary hover:underline">contact@myquotidia.app</a>
            </p>
          </section>
              ...
              <table className="w-full text-xs border-collapse">
                ...
                <tbody className="text-textLight">
                  {[
                    ...
                    ["Données bancaires agrégées", "Suivi budgétaire (via Bridge)", "Consentement"],
          ...
          <section>
            <h2 className="text-lg font-bold mb-3">4. Partage des données et transferts hors UE</h2>
            ...
            <ul className="space-y-2 text-textLight pl-4 border-l-2 border-gray-100">
              ...
              <li><strong className="text-textDark">Vercel</strong> — hébergement application (États-Unis)</li>
              <li><strong className="text-textDark">Stripe</strong> — traitement des paiements (certifié PCI-DSS)</li>
              <li><strong className="text-textDark">OpenAI</strong> — traitement IA des conversations (données pseudonymisées, États-Unis)</li>
              <li><strong className="text-textDark">Bridge</strong> — agrégation bancaire, agréé par l&apos;ACPR en tant qu&apos;établissement de paiement (DSP2)</li>
            </ul>
            <p className="mt-3 text-textLight">
              Certains de ces prestataires (Vercel, OpenAI) sont situés aux États-Unis. Ces transferts sont encadrés par des clauses contractuelles types de la Commission européenne et/ou l&apos;adhésion au Data Privacy Framework UE-États-Unis, garantissant un niveau de protection adéquat de vos données.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3">
              Pour exercer vos droits : <a href="mailto:contact@myquotidia.app" className="text-primary hover:underline">contact@myquotidia.app</a>. Vous pouvez également saisir la <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">CNIL</a> en cas de réclamation.
            </p>
          </section>

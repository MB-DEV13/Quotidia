    ...
    <main className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="pt-32 pb-20 px-4 text-center relative">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white rounded-full px-4 py-2 shadow-soft text-sm text-primary font-medium mb-6 border border-primary/10">
            <span>✨</span> Gratuit pour commencer — Premium à 4,99€/mois
          </div>
          ...
          <div className="flex items-center justify-center gap-6 text-sm text-textLight flex-wrap">
            <span className="flex items-center gap-1.5">
              <span className="text-success font-bold">✓</span> Sans carte
              bancaire
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-success font-bold">✓</span> Annulation à
              tout moment
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-success font-bold">✓</span> Données
              sécurisées
            </span>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-card p-5 border border-sky-100">
              ...
              <div className="mt-4 flex items-center gap-2 bg-gray-50 rounded-xl px-3 py-2">
                <input
                  ...
                  readOnly
                />
                <button aria-label="Envoyer" className="w-7 h-7 rounded-lg bg-sky-500 flex items-center justify-center flex-shrink-0">
                  <svg
      ...
      {/* ── CTA final ────────────────────────────────────────────── */}
      <section className="px-4 py-24 bg-background text-center">
        <div className="max-w-2xl mx-auto">
          <div className="text-5xl mb-6">🌀</div>
          <h2 className="text-3xl md:text-5xl font-extrabold text-textDark mb-4">
            Prêt à changer ton quotidien ?
          </h2>
          <p className="text-textLight text-lg mb-10">
            Rejoins des milliers d&apos;utilisateurs qui ont transformé leurs
            habitudes, leur budget et leurs objectifs grâce à Quotidia.
          </p>
          <Link
            href="/register"
            className="inline-block bg-gradient-to-r from-primary to-accent hover:opacity-90 text-white font-bold px-10 py-4 rounded-2xl transition-all shadow-card text-lg"
          >
        ...
        <div className="max-w-6xl mx-auto space-y-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a href="#features" className="hover:text-textDark transition">Fonctionnalités</a>
              <a href="#pricing" className="hover:text-textDark transition">Tarifs</a>
              <Link href="/contact" className="hover:text-textDark transition">Contact</Link>
              <Link href="/legal/mentions-legales" className="hover:text-textDark transition">Mentions légales</Link>
              <Link href="/legal/confidentialite" className="hover:text-textDark transition">Confidentialité</Link>
              <Link href="/legal/cgu" className="hover:text-textDark transition">CGU / CGV</Link>
            </div>
            <div className="flex items-center gap-3">
              <a href="https://instagram.com/quotidia" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-textDark transition">
              ...
              <a href="https://x.com/quotidia" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="hover:text-textDark transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.747l7.73-8.835L1.254 2.25H8.08l4.253 5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://facebook.com/quotidia" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-textDark transition">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <p className="text-center">© {new Date().getFullYear()} Quotidia. Tous droits réservés.</p>
        </div>
      </footer>
      <PWAInstallModal />
    </main>

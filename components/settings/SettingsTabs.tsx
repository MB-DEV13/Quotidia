        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow-soft p-5 text-center">
            ...
            <div className="flex items-center justify-center gap-3">
              <a href="https://instagram.com/quotidia.app" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              ...
              <a href="https://x.com/QuotidiaApp" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)"
              ...
              <a href="https://facebook.com/61572147742258" target="_blank" rel="noopener noreferrer" aria-label="Facebook"

  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <div>
          <p className="text-sm font-medium text-textDark">{t("changePassword")}</p>
          <p className="text-xs text-textLight mt-0.5">{t("changePasswordHint")}</p>
        </div>
        <button
        ...
        >
          {open ? tProfile("cancel") : tProfile("edit")}
        </button>
      </div>
